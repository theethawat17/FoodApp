...
class Page5 extends StatelessWidget {
  ...
  void _launchYouTube() async {
    final Uri youtubeUrl = Uri.parse('https://www.youtube.com/watch?v=oFLJyxRsxvQ');
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              context,
              MaterialPageRoute(
              builder: (context) => Page6(title: 'น้ำโกโก้'),
              ),
            );
            },
          ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // คำอธิบายอาหาร
                Text(
                  'ก๋วยเตี๋ยวเป็นอาหารประเภทเส้นของชาวจีนแต้จิ๋วและฮกเกี้ยน มีลักษณะคล้ายกับป่านเถียว  ของชาวจีนกวางตุ้ง เฝอของชาวเวียดนาม และข้าวซอยก็นับเป็นเส้นก๋วยเตี๋ยวชนิดหนึ่ง ซึ่งเป็นอาหารพื้นบ้านทางภาคเหนือของไทย ส่วนก๋วยเตี๋ยวที่ไม่ใส่เส้นจะเรียกว่าเกาเหลา',
